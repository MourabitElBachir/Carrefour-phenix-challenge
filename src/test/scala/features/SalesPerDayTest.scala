...
import models.{ItemSale, ItemSalePerShop, SalesPerShop, Transaction}
import org.scalatest.FunSuite

class SalesPerDayTest extends FunSuite {

  private val formatter: DateTimeFormatter = DateTimeFormatter.ofPattern("yyyyMMdd")

  test("Day-Sales: ComputePerShop Test") {
    ...
    val result: List[(UUID, List[ItemSalePerShop])] = SalesPerDay.computePerShop(transactions)
